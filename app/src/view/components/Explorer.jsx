...
export default function Explorer() {
  ...
  return (
    <section className="pt-2 pb-20 flex flex-col items-center">
        ...
        {users?.map((user) => (
          ...
          >
            <div className="flex items-center">
              ...
              />
              <a
                onClick={() => handleProfile(event, user.id)}
          ...
          <article key={post.id} className="bg-color5 mb-3">
            <div className="flex justify-between items-center">
              ...
              <button
                ...
                className="bg-color4 w-10 h-9 text-white border-none rounded-xl px-2 py-1 font-bold text-lg cursor-pointer transition duration-300 hover:bg-color3"
              >
                {post.fav ? "🤍" : "♡"}
              </button>
            </div>
              ...
              <div className="border-x-color5 border-x-8 bg-white p-1">
                {post?.comments.map((comment) => (
                  <article className="flex items-start m-1" key={comment.id}>
                    ...
                    <a
                      onClick={(event) =>
                        handleProfile(event, comment.author.id)
                      }
